...
INSERT INTO colors(name_en, name_sk, created_at, updated_at)
VALUES ('red', 'červená', now(), now()),
       ('green', 'zelená', now(), now()),
       ('blue', 'modrá', now(), now()),
       ('yellow', 'žltá', now(), now()),
       ('purple', 'fialová', now(), now()),
       ('pink', 'ružová', now(), now()),
       ('white', 'biela', now(), now()),
       ('gray', 'sivá', now(), now()),
       ('black', 'čierna', now(), now());


INSERT INTO smartphones(name, price, quantity, brand_id, color_id, description, ram, operating_system, os_version,
                        display_size, resolution, height, width, thickness, created_at, updated_at)
VALUES ('Samsung Galaxy A52 6GB/128GB', 189.99, 10, 1, 1,
        ...
        6144, 'Android', 11, 6.5, '2400 x 1080', 159.9, 75.1, 8.4, now(), now()),
       ('Xiaomi Redmi Note 10 Pro 6GB/128GB', 299.00, 20, 3, 2,
        ...
        6144, 'Android', 11, 6.67, '2400 x 1080', 164, 76.5, 8.1, now(), now()),
       ('Apple iPhone 12 128GB', 818.90, 30, 7, 3,
        ...
        4096, 'iOS', 14, 6.1, '2532 x 1170', 146.7, 71.5, 7.4, now(), now()),
       ('Apple iPhone 11 64GB', 638.00, 50, 7, 4,
        ...
        4096, 'iOS', 13, 6.1, '1792 x 828', 150.9, 75.7, 8.3, now(), now()),
       ('Samsung Galaxy S20 6GB/128GB Dual SIM', 468.00, 100, 1, 5,
        ...
        6144, 'Android', 10, 6.5, '2400 x 1080', 159.8, 74.5, 8.4, now(), now()),
       ('Samsung Galaxy S21 5G 8GB/128GB', 705.90, 200, 1, 6,
        ...
        8192, 'Android', 11, 6.2, '2400 x 1080', 151.7, 71.2, 7.9, now(), now()),
       ('Samsung Galaxy A12 4GB/64GB', 178.90, 150, 1, 7,
        ...
        4096, 'Android', 10, 6.5, '1600 x 720', 164.0, 75.8, 8.9, now(), now()),
       ('Xiaomi Redmi 9A 2GB/32GB', 109.99, 100, 3, 8,
        ...
        2048, 'Android', 10, 6.53, '1600 x 720', 164.9, 77.07, 9, now(), now()),
       ('Xiaomi Redmi Note 9 Pro 6GB/128GB', 239.00, 90, 3, 9,
        ...
        6144, 'Android', 10, 6.67, '2340 x 1080', 165.75, 76.68, 8.8, now(), now()),
       ('Huawei P30 Lite 4GB/128GB Dual SIM', 209.90, 25, 2, 1,
        ...
        4096, 'Android', 9, 6.15, '2312 x 1080', 152.9, 72.7, 7.4, now(), now()),
       ('Huawei P Smart 2021 Dual SIM', 199.99, 17, 2, 2,
        ...
        4096, 'Android', 10, 6.67, '1400 x 1080', 165.65, 76.88, 9.26, now(), now()),
       ('Huawei P40 Lite 6GB/128GB Dual SIM', 219.99, 19, 2, 3,
        ...
        6144, 'Android', 10, 6.4, '2310 x 1080', 159.2, 76.3, 8.7, now(), now()),
       ('Lenovo K10 Note 6/128', 199.00, 45, 4, 4,
        ...
        6144, 'Android', 9, 6.3, '2340 x 1080', 156.6, 74.3, 7.9, now(), now()),
       ('Nokia G10', 129.90, 22, 5, 5,
        ...
        3072, 'Android', 11, 6.5, '1600 x 720', 164.9, 76.0, 9.2, now(), now()),
       ('Nokia 8000 Dual Sim', 75.90, 310, 5, 6,
        ...
        512, 'Android', 9, 2.8, '320 x 240', 132.2, 56.5, 12.3, now(), now()),
       ('Sony Xperia 10 6GB/128GB Dual SIM', 403.09, 40, 6, 7,
        ...
        6000, 'Android', 11, 6.0, '2520 x 1080', 154.0, 68.0, 8.3, now(), now()),
       ('Sony Xperia 1 12GB/256GB', 1299.00, 3, 6, 8,
        ...
        12288, 'Android', 11, 6.5, '1644 x 3840', 165.0, 71.0, 8.2, now(), now()),
       ('Sony Xperia 5', 999.00, 0, 6, 9,
        ...
        8192, 'Android', 10, 6.1, '2520 x 1080', 157.0, 68.0, 8.2, now(), now()),
       ('Nokia 150 Single Sim', 34.90, 61, 5, 1,
        'Nokia 150 v sebe snúbi pekný dizajn s praktickosťou. Telo telefónu si zachová vždy svojou farbu vďaka použitému polykarbonátu. Pod prehľadným 2,4" farebným displejom sa nachádzajú prehľadné veľké tlačidlá vďaka ktorým budeme mať vždy istý stisk.',
        512, 'Android', 10, 2.4, '240 x 320', 118.0, 50.0, 13.5, now(), now());
