            ...
            <div class="flex space-x-2 lg:space-x-4 items-center mr-2 md:mr-0">
                <div class="hidden sm:inline">
                    <div class="relative text-gray-600 focus-within:text-gray-400">
                        <input type="search" name="search" class="w-64 pl-5 pr-10 py-2 bg-white text-black placeholder-gray-600 focus:outline-none rounded-full" placeholder="Tvoj vysnívaný smartfón" autocomplete="off" />
