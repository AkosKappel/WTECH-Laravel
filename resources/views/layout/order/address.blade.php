            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 col-gap-32">
                <div class="lg:col-span-1">
                    ...
                    <div class="my-6 text-left grid grid-cols-3">
                        ...
                        <div class="md:w-2/3 col-span-2 flex justify-en">
                            <input value="{{Auth::check() && Auth::user()->first_name ? Auth::user()->first_name : ""}}"
                                   id="name" type="text" placeholder="Meno"
                    ...
                    <div class="my-6 text-left grid grid-cols-3">
                        ...
                        <div class="md:w-2/3 col-span-2 flex justify-end">
                            <input value="{{Auth::check() && Auth::user()->last_name ? Auth::user()->last_name : ""}}"
                                   id="surname" type="text" placeholder="Priezvisko"
                                   class="text-base shadow appearance-none border rounded -mt-1 sm:-mt-2 w-full py-2 ml-2 sm:ml-0 px-3 sm:mr-2 text-gray-700 leading-tight focus:border-gray-500 focus:outline-none focus:shadow-outline rounded-full" />
                        </div>
                    </div>
                    <div class="my-6 text-left grid grid-cols-3">
                        ...
                        <div class="md:w-2/3 col-span-2 flex justify-end">
                            <input value="{{Auth::check() && Auth::user()->phone_number ? Auth::user()->phone_number : ""}}"
                                   id="phone" type="text" placeholder="Telefón"
                                   class="text-base shadow appearance-none border rounded -mt-1 sm:-mt-2 w-full py-2 ml-2 sm:ml-0 px-3 sm:mr-2 text-gray-700 leading-tight focus:border-gray-500 focus:outline-none focus:shadow-outline rounded-full" />
                        </div>
                    </div>
                    <div class="my-6 text-left grid grid-cols-3">
                        ...
                        <div class="md:w-2/3 col-span-2 flex justify-end">
                            <input value="{{Auth::check() && Auth::user()->email ? Auth::user()->email : ""}}"
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="my-6 text-left grid grid-cols-3">
                        ...
                        <div class="md:w-2/3 col-span-2 flex justify-end">
                            <input value="{{Auth::check() && Auth::user()->street ? Auth::user()->street : ""}}"
                                   id="street" type="text" placeholder="Ulica"
                    ...
                    <div class="my-6 text-left grid grid-cols-3">
                        ...
                        <div class="md:w-2/3 col-span-2 flex justify-end">
                            <input value="{{Auth::check() && Auth::user()->descriptive_number ? Auth::user()->descriptive_number : ""}}"
                                   id="streetNumber" type="text" placeholder="Popisné číslo"
                    ...
                    <div class="my-6 text-left grid grid-cols-3">
                        ...
                        <div class="md:w-2/3 col-span-2 flex justify-end">
                            <input value="{{Auth::check() && Auth::user()->city ? Auth::user()->city : ""}}"
                                   id="town" type="text" placeholder="Mesto"
                    ...
                    <div class="my-6 text-left grid grid-cols-3">
                        ...
                        <div class="md:w-2/3 col-span-2 flex justify-end">
                            <input value="{{Auth::check() && Auth::user()->country ? Auth::user()->country : ""}}"
                                   id="country" type="text" placeholder="Krajina"
                                   class="text-base shadow appearance-none sm:mr-2 border rounded w-full ml-2 sm:ml-0 py-2 -mt-1 sm:-mt-2 px-3 text-gray-700 leading-tight focus:border-gray-500 focus:outline-none focus:shadow-outline rounded-full" />
                        </div>
                    </div>
                </div>
